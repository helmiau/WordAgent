STRINGS = {
    ...
    "office": {
        ...
        "infobar": {
            "downloadFailed": {"title": "다운로드 실패", "contentMissing": "gui/resources/manifest.xml을 찾을 수 없습니다"},
            ...
            "startFailed": {"title": "시작 실패", "contentMissingDist": "microsoft_word_plugin/dist를 찾을 수 없습니다. 먼저 프론트엔드를 빌드하세요"},
            "startSuccess": {"title": "성공적으로 시작했습니다", "content": "HTTPS 서비스를 시작했습니다: https://{host}:{port}"},
    ...
    "language": {"label": "언어", "english": "English", "chinese": "简体中文", "indonesian": "Bahasa Indonesia", "japanese": "日本語", "korean": "한국어", "vietnamese": "Tiếng Việt"},
