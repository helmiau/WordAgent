...
MODEL_CALL_RUN_LIMIT = _get_env_int("WORDAGENT_AGENT_RECURSION_LIMIT", 50)
MODEL_CALL_LIMIT_EXIT_BEHAVIOR = "end"
INVALID_TOOL_CALL_MAX_RETRIES = _get_env_int("WORDAGENT_INVALID_TOOL_CALL_MAX_RETRIES", 2)
